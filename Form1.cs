...
namespace Modeling1
{
         ...
         */
            ...
            private void findAmountOfDowntime2xn()
            {
                ...
                labelDowntime.Location = new Point(13, 100);
            ...
            private void DrawGant2xn()
            {
                ...
                Rectangle rec = new Rectangle(13, 200, 1, 20);
                int width;
        ...
        private void buttonTask2_Click(object sender, EventArgs e)
            ...
            private void buttonCheck_Click(object sender, EventArgs e)
            {
                ...
                if (check == true)
                {
                    labelDowntime.Visible = true;
                    labelDowntime.Location = new Point(13, 100);
                    labelDowntime.Text = "Условие выполняется";
                    convertToNx2();
                }
                else
                {
                    labelDowntime.Visible = true;
                    labelDowntime.Location = new Point(13, 100);
                    labelDowntime.Text = "Условие не выполняется";
                    task2 = Sort(task2);
                }
            }
